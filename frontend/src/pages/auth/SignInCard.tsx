 ...
 * SignInCard
 * 
 * Single responsibility: Render sign-in UI only
 * - NO business logic
 * - NO state management
 * - NO API calls
 * - NO navigation
 ...
 * - Easy to test (all inputs are props)
 * - Highly reusable
 * 
 * @example
 * <SignInCard
  ...
  return (
    <div className='flex flex-col pt-5 '>
      ...
      <div className="mb-8 flex flex-col items-center">
        <h2 className="text-3xl font-bold text-gray-900 m-7 ">Welcome back</h2>
      ...
      <div className="space-y-5">
        ...
        <Button
          ...
          onClick={onSubmit}
          disabled={isLoading || isSuccess}
          className="bg-indigo-600 hover:bg-indigo-700 text-white focus:ring-indigo-500/50 shadow-lg hover:shadow-xl mt-6"
        >
          {isLoading ? (
